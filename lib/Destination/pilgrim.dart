...
class Pilgrim extends StatelessWidget {
  ...
  Widget BackgroundImage() {
    return SizedBox(
        ...
        child: Image(
          fit: BoxFit.fill,
          image: AssetImage('assets/images/pilgrimsofkashmir.png')),
    );
  }
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          PilgrimCard('Shankaracharya Temple',
          ...
          PilgrimCard('Sikh Gurudwara Chhatti Padshahi',
          ...
          PilgrimCard('Sharika Devi Temple',
