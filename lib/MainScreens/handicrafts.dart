            ...
            Container(
              ...
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(bottom: 8.0),
                    child: Text('‘Paper mache’ is a French term which when translated literally means ‘chewed paper’. This art is said to have originated in China hundreds of years ago.',
                    style: kNormalText,
                    textAlign: TextAlign.justify,),
                  ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(bottom: 8.0),
                    child: Text('History',style: kHeading,),
                  ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('How are Kashmir Paper Mache Crafts Made?',
                    style: kHeading,),
                  ),
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Tilla/tilla.png')),
            ),
            Container(
              margin: EdgeInsets.all(10.0),
              child: Column(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Tilla/Tilla1.webp')),
            ),
          ],
        ),
      )),
          ...
          child: Column(
            children: [
              ...
              Container(
               ...
               Padding(
                 padding: const EdgeInsets.all(8.0),
                 child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Wood/Wood.png'),),
               ),
              Container(
                margin: EdgeInsets.all(10.0),
                child: Column(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Wood/woodselection.jpeg')),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(bottom:5.0,top:5.0),
                      child: Text(
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: devW*0.95,
                        child: Image(
                            image: AssetImage('assets/images/Handicrafts/Carousel/Wood/designcreation.jpg'),fit: BoxFit.fill,),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(bottom:5.0,top:5.0),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top:20,bottom:20),
                      child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Wood/woodblocking.jpeg')),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(bottom:5.0,top:5.0),
                      child: Text(
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top:20,bottom:20),
                      child: Image(image: AssetImage('assets/images/Handicrafts/Carousel/Wood/intricatecarving.jpeg')),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(bottom:5.0,top:5.0),
                      child: Text(
