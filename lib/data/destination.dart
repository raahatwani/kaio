...
import 'package:kaio/Destination/Container.dart';
import 'package:kaio/Destination/Features.dart';
import 'package:kaio/Destination/carouselPage.dart';
...
List<FeatureCard> heritage = [
  FeatureCard(
    ...
    imagePath: 'assets/images/hariparbatfort.jpg',
  ),
  FeatureCard(
    heading: 'Pari Mahal',
    description:
    ...
    imagePath: 'assets/images/pariimahal.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/martandsuntemple.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/parihaspora.jpeg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/patharmosque.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/kathidarwaza.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/khanqahemoula.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/budshahtomb.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/jamiamasjid.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/akhundmullahshahmasjid.jpg',
  ),
  FeatureCard(
    heading: 'Burzahom',
    description:
    ...
    imagePath: 'assets/images/burzahom.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/harwanmonastry.jpeg',
  ),
];
List<FeatureCard> shrine = [
  FeatureCard(
    ...
    imagePath: 'assets/images/hazratbal.JPG',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/dastagirsahab.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/makhdoomsahib.webp',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/babareshi.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/aishmuqam.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/naqshbandsahab.jpg',
  ),
];
List<FeatureCard> pilgrim = [
  FeatureCard(
   ...
   imagePath:'assets/images/amarnath.avif',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/shankracharya.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/kheerbawani.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/chattipadshahi.jpg',
  ),
  FeatureCard(
    ...
    imagePath: 'assets/images/sharikadevi.jpg',
  ),
];
